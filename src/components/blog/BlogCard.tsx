...
export default function BlogCard({ post, variant = "default" }: BlogCardProps) {
  ...
  if (variant === "featured") {
    return (
      <Link href={`/blog/${post.slug}`}>
        <article className="group cursor-pointer rounded-2xl overflow-hidden border transition-all duration-300 hover:shadow-xl hover:border-[var(--brand-purple)]"
          style={{
  ...
  if (variant === "compact") {
    return (
      <Link href={`/blog/${post.slug}`}>
        <article className="group cursor-pointer flex gap-4 p-4 rounded-lg border transition-all duration-300 hover:bg-[var(--hover-bg)]"
          style={{
            backgroundColor: "var(--card-bg)",
            borderColor: "var(--border-color)",
          }}>
  ...
  return (
    <Link href={`/blog/${post.slug}`}>
      <article className="group cursor-pointer rounded-xl overflow-hidden border transition-all duration-300 hover:shadow-lg hover:border-[var(--brand-purple)]"
        style={{
          backgroundColor: "var(--card-bg)",
          borderColor: "var(--border-color)",
        }}>
